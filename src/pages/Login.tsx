    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--gradient-dark)' }}>
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-muted-foreground text-sm mt-1">Sign in to your SmartBite account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-lg input-dark text-sm"
            />
          </div>
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                placeholder="••••••••"
                className="w-full px-4 py-2.5 rounded-lg input-dark text-sm pr-10"
              />
        ...
        <p className="text-center text-xs text-muted-foreground mt-2">
          Tip: Use email ending with @admin.com for admin access
        </p>
      </motion.div>
    </div>
  );
